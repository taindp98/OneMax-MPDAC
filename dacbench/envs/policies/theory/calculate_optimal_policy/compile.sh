...
dmd2/${OS_NAME}/${BIN_DIR}/dmd -O -release ./calculatePolicy.d ./data_management.d ./eas.d -L-ld_classic # the last flag (-L-ld_classic) is to fix a compilation issue with macOS Sonoma)
